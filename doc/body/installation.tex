...
您也可以通过访问项目主页的方式获取最新版本的 \cls{exam-zh}（通常情况下，GitHub 和 Gitee 的版本会大于等于 CTAN 的版本（因为 CTAN 从上传到审核到用户可以下载需要一天左右））。主要以「下载发行版」的方式获取最新版本的 \cls{exam-zh}：

\begin{enumerate}
  \item 进入项目主页（\href{https://github.com/xkwxdyy/exam-zh}{GitHub 项目主页} 或 \href{https://gitee.com/xkwxdyy/exam-zh}{Gitee 项目主页（国内镜像）}，Gitee 界面见图~\ref{figure:gitee项目主页}）
  \item 在右侧一列有"发行版"（Gitee）或"Releases"（GitHub），并且有一个标签图标并有"vx.x.x - 20xx-xx-xx"字样，表示最新的发行版版本和发布时间，点击即可查看相关信息（如果想查看历史所有发行版信息，可以点击"发行版"右侧的"全部"）。

    发行版中一般由以下信息构成（\href{https://github.com/xkwxdyy/exam-zh/releases}{GitHub Releases} 或 \href{https://gitee.com/xkwxdyy/exam-zh/releases}{Gitee 发行版}，Gitee 界面见图~\ref{figure:gitee发行版}）
      \begin{itemize}
...
\begin{table}[htbp]
  ...
  \begin{tblr}{
    ...
    \file{exam-zh-math.sty}       & 模版的计算题与多图并排模块宏包\\
